...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('gacha'))
      .map(p => ({
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  𖡹 *SISTEMA GACHA:*
  🎲 Tiradas, personajes y colecciones.
  💰 ${moneda}: ${userCoins}
  🏦 Banco: ${userBank}
  ✨ Experiencia: ${userExp}
...
`
    ...
    console.error('💥 Error en menú gacha:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de gacha.`, m)
  }
}
