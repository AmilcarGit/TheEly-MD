...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('fun'))
      .map(p => ({
    ...
    const comandosFun = help.map(menu => {
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  𓅋 *COMANDOS DE DIVERSIÓN:*
  🎮 Juegos, memes, chistes y más.
  😂 Pasa un buen rato con el bot.
  💰 ${moneda}: ${userCoins}
  🏦 Banco: ${userBank}
  ✨ Experiencia: ${userExp}

  ❀•°•═════ஓ๑♡๑ஓ═════•°•❀
  📂 𝗖𝗢𝗠𝗔𝗡𝗗𝗢𝗦 𝗗𝗘 𝗗𝗜𝗩𝗘𝗥𝗦𝗜𝗢́𝗡
  ─────────────────────────────
`
...
`
    ...
    console.error('💥 Error en menú diversión:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de diversión.`, m)
  }
}

handler.command = ['menufun', 'diversion', 'fun', 'entretenimiento']
handler.tags = ['main']
handler.help = ['menufun']
handler.desc = 'Muestra el menú de comandos de diversión del bot'
