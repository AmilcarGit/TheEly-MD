...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('multijugador'))
      .map(p => ({
    ...
    const totalMulti = help.length

    const comandosMulti = help.map(menu => {
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  ꒷ *MULTIJUGADOR:*
  🎮 Juegos multijugador: ${totalMulti}
  👥 Juega con tus amigos y gana premios.
  🏆 Compite y demuestra quién es el mejor.
...
`
    ...
    console.error('💥 Error en menú multijugador:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de multijugador.`, m)
  }
}

handler.command = ['multiplayer', 'multijugador']
handler.tags = ['main']
