...
`
    ...
    console.error('💥 Error en menú stickers:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de stickers.`, m)
  }
}

handler.command = ['menusticker', 'sticker', 'stickers', 'stiker']
handler.tags = ['main']
handler.help = ['menusticker']
handler.desc = 'Muestra el menú de comandos de stickers del bot'
