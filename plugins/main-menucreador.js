...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('creador'))
      .map(p => ({
    ...
    const comandosCreador = help.map(menu => {
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  ☕ *COMANDOS DE CREADOR:*
  👑 Administración y control del bot.
  ⚙️ Configuración, reinicio y gestión.
...
`
    ...
    console.error('💥 Error en menú creador:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de creador.`, m)
  }
}

handler.command = ['menucreador', 'creador', 'owner', 'admin']
handler.tags = ['main']
handler.help = ['menucreador']
handler.desc = 'Muestra el menú de comandos de creador del bot'
